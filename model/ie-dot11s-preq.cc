...
IePreq::IePreq () :
  ...
  m_destCount (0),m_processing_delay_required (0),m_bandwidth_required (0), m_pathid (0)          //////////////////
{
}
...
void
IePreq::SetPathId (uint32_t pathid)              ///////////////
{
  m_pathid = pathid;
}
...
operator== (const IePreq & a, const IePreq & b)
{
  bool ok = (a.m_flags == b.m_flags && a.m_hopCount == b.m_hopCount && a.m_ttl == b.m_ttl && a.m_preqId
    ...
    == b.m_destCount && a.m_processing_delay_required == b.m_processing_delay_required && a.m_bandwidth_required == b.m_bandwidth_required && a.m_pathid == b.m_pathid);////////             
