...
#include "ns3/maher-information-element-vector.h"
...
public:
  ...
  void SetProcessing_delay_required (uint8_t processing_delay_required);         //////////////////
  void SetBandwidth_required (uint8_t bandwidth_required);                       //////////////////
  /**
   * Get flags function
   * \returns the flags
   */
  ...
  uint8_t GetProcessing_delay_required () const;    
  uint8_t GetBandwidth_required () const;           
