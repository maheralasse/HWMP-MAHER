...
IePrep::IePrep () :
  ...
  m_originatorSeqNumber (0),m_processing_delay_required (0),m_bandwidth_required (0),m_pathid (0) //                  //////////////
{
}
...
void
IePrep::SetProcessing_delay_required (uint8_t processing_delay_required)                  //////////////
{
  m_processing_delay_required = processing_delay_required;
}

void
IePrep::SetBandwidth_required (uint8_t bandwidth_required)                  //////////////
{
...
uint8_t
IePrep::GetProcessing_delay_required () const                             //////////////
{
...
uint8_t
IePrep::GetBandwidth_required () const                             //////////////
{
...
void
IePrep::SetPathId (uint32_t pathid)       /////////////
{
  m_pathid = pathid;
}
uint32_t
IePrep::GetPathId () const           /////////////
{
  return m_pathid;
}
...
IePrep::Print (std::ostream& os) const
{
  os << "PREP=(Flags=" << m_flags << ", Hopcount=" << m_hopcount << ", TTL=" << m_ttl
     ...
     << m_originatorAddress << ", Orig. seqnum=" << m_originatorSeqNumber << ", Processing Delay Required=" << m_processing_delay_required
     << ", Bandwidth Required=" << m_bandwidth_required << ", PathId=" << m_pathid ")";                                                                                                             //////////////
}
bool
operator== (const IePrep & a, const IePrep & b)
{
  return ((a.m_flags == b.m_flags) && (a.m_hopcount == b.m_hopcount) && (a.m_ttl == b.m_ttl)
          ...
          && (a.m_lifetime == b.m_lifetime) && (a.m_metric == b.m_metric) && (a.m_originatorAddress
		   ...
		   (a.m_processing_delay_required == b.m_processing_delay_required)
		   && (a.m_bandwidth_required == b.m_bandwidth_required)&& 
		   (a.m_pathid == b.m_pathid));                                    //////////////
}
std::ostream &
