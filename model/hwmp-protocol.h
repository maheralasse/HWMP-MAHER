...
#include "ns3/maher-l2-routing-protocol.h"
...
private:
  ...
  ///\}
    typedef std::pair<Mac48Address, Mac48Address> multpath;
	std::map<multpath,std::pair<uint32_t, uint32_t>> m_hwmpSeqnoMetricDatabaseMP; ///////
